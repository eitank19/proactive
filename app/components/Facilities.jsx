    ...
    <div className="max-w-[68.125rem] mx-auto w-[calc(100%-1.25rem)]">
      ...
      <div className="block relative lg:hidden mt-[6.25rem]">
        <img
          ...
          alt=""
        />
        <div className="gradient-top absolute bottom-0 w-full h-full flex flex-col justify-end items-center"></div>
      </div>
      <div className="block mt-[-5.5rem] sm:mt-[-9rem] relative lg:hidden">
        <p className="text-lg tracking-[0.038rem] leading-6 font-normal text-center [text-shadow:0_0_1.563rem_rgba(0,0,0,0.3)] mb-3">
          זה היה לא צפוי אבל בסוף זה קרה...
        </p>
        <h1 className="text-[1.875rem] tracking-[0.064rem] leading-9 font-black text-center [text-shadow:0_0_1.563rem_rgba(0,0,0,0.3)] mb-5">
          אפילו אצלנו בגולן
        </h1>
      ...
      <div className="mt-8 flex justify-between items-center flex-wrap gap-7 lg:gap-4 xl:gap-6">
        <FacilitiesCard />
        <FacilitiesCard />
        <FacilitiesCard />
        <FacilitiesCard />
